...
class _ScheduleViewState extends State<ScheduleView> {
  ...
  List notArr = [
    ...
    },
    {
      "day": "14",
      "detail":
          "Советы по снижению веса направлены на выполнение функциональных упражнений, проверку силы и равновесия, а также снижение риска травм, когда группы мышц активны одновременно."
    },
  ];
