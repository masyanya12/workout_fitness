...
class _MealPlanView2State extends State<MealPlanView2> {
  int isActiveTab = 0;
  List workArr = [
    {"name": "Завтрак", "title":"Манная каша, творог", "image": "assets/img/f1.png"},
    {"name": "Перекус", "title": "Банан, орех, сливочное масло", "image": "assets/img/f2.png"},
    {
      "name": "Обед",
      "title": "Мясо, яйца, морепродукты",
      "image": "assets/img/f3.png",
    },
    {
      "name": "Ужин",
       "title": "Курица, макароны, рыба",
